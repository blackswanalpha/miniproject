...
<body>
		...
		<ul>
			...
			<li><a href="admin_home.php">Products</a>
				<ul>
					...
					<li><a href="admin_product.php "style="font-size:15px; margin-left:15px;">Book</a></li>
					<li><a href="admin_football.php" style="font-size:15px; margin-left:15px;">stationaries</a></li>
					<li><a href="admin_running.php"style="font-size:15px; margin-left:15px;">office stuff</a></li>
				</ul>
			</li>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>office stuff</h2></center></div>
			<br />
